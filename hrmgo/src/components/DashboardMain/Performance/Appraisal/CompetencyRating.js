                ...
                {[5, 4, 3, 2, 1].map((star) => (
                  <React.Fragment key={`projectManagement-${star}`}>
                    <input
                      ...
                      onChange={() =>
                        handleRatingChange("projectManagement", star)
                      }
                    />
                    <label
                      className="full"
                ...
                {[5, 4, 3, 2, 1].map((star) => (
                  <React.Fragment key={`allocatingResources-${star}`}>
                    <input
                      ...
                      onChange={() =>
                        handleRatingChange("allocatingResources", star)
                      }
                    />
                    <label
                      className="full"
                ...
                {[5, 4, 3, 2, 1].map((star) => (
                  <React.Fragment key={`businessProcess-${star}`}>
                    <input
                      ...
                      onChange={() =>
                        handleRatingChange("businessProcess", star)
                      }
                    />
                    <label
                      className="full"
                ...
                {[5, 4, 3, 2, 1].map((star) => (
                  <React.Fragment key={`oralCommunication-${star}`}>
                    <input
                      ...
                      onChange={() =>
                        handleRatingChange("oralCommunication", star)
                      }
                    />
                    <label
                      className="full"
