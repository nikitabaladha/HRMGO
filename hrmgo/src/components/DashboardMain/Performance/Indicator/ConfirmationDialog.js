...
// function ConfirmationDialog({ onClose, indicatorId }) {
//   const handleDelete = async () => {
//     try {
//       const response = await deleteAPI(`/indicator/${id}`, {}, true);

//       if (!response.hasError) {
//         console.log(`Leave status updated to`, response.data.data.status);
//         onCancel();
//         onDeleted(indiactorId);
...
//       toast.error("An error occurred while deleting indicator.");
//     }
//   };
//   useEffect(() => {
