...
//           indicator={selectedIndicator} // Pass selected indicator data as a prop
//           // i want to fetch indicator of that perticular modal  accoridng  to id not any random so what to do how to pass id and fetch data accoring to it?
//         />
//       )}
//       {/* i want to pass indicator data to this detail modal to just display as read only thing  */}
//     </>
//   );
// };
